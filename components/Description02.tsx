...
const Description02 = () => {
  const description2app = "/description-2-app.jpg";
              ...
              <div className="tab-content" id="cedoTabsContent">
                ...
                >
                  ...
                  <p>
                    ...
                    algorithms have been built to be flexible and functional for
                ...
                >
                  ...
                  <ul className="list-unstyled li-space-lg">
                    ...
                    <li className="media">
                      <i className="far fa-check-square"></i>
                      <div className="media-body">
                        It's the first mobile app that can turn you in a better
                        organized person without the pressure of failing like
                        other systems
                      </div>
                    </li>
                    <li className="media">
                      <i className="far fa-check-square"></i>
                      <div className="media-body">
                        Recognized by a lot of trainers and life coaches Sync is
                        the number one tool they recommend time management
                      </div>
                    </li>
                  </ul>
                </div>
